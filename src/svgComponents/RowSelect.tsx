...
const RowSelect: React.FC<Props> = props => {
  return (
    <svg
    ...
    >
      <g
        ...
        <g
          ...
          <g
            id="g4706"
            transform="matrix(0,-1.2058113,1.2782563,0,-51.740497,312.8549)"
            style={{fill:"#ffffff",fillOpacity:1,stroke:"none", ...props.style}}
